...
ACCESS_TOKEN_EXPIRE_MINUTES_INT = int(ACCESS_TOKEN_EXPIRE_MINUTES) # type: ignore
...
def create_access_token(data: dict, expires_delta: Optional[timedelta] = None):
    ...
    if expires_delta:
        ...
        expire = datetime.now(timezone.utc) + timedelta(minutes=ACCESS_TOKEN_EXPIRE_MINUTES_INT)
